// src/components/ui/ProfileEditModal.tsx
...
export function ProfileEditModal({ isOpen, onClose, onSave, initialData }: ProfileEditModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="bg-[#141414]/80 backdrop-blur-md border border-white/10 text-white max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
        ...
        <div className="space-y-6 py-4">
          ...
          <div className="relative mb-12">
            {/* Capa */}
            <div className="h-24 w-full bg-gray-800 rounded-md overflow-hidden relative group">
            ...
            <div className="absolute -bottom-10 left-4">
              <div className="relative group">
                <div className="w-20 h-20 rounded-full border-4 border-[#141414] bg-gray-700 overflow-hidden">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                className="bg-[#1a1a1a] border border-white/10 text-white focus:border-purple-500"
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              value={formData.bio || ''}
              onChange={handleChange}
              className="bg-[#1a1a1a] border border-white/10 text-white focus:border-purple-500 min-h-[80px]"
            ...
            <div className="grid grid-cols-1 gap-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <Input
                  ...
                  onChange={handleChange}
                  className="bg-[#1a1a1a] border border-white/10 text-white focus:border-purple-500"
                  placeholder="Seu portfolio ou site"
                />
              </div>
            </div>
          </div>
